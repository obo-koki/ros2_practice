...
#include "example_interfaces/msg/u_int16__rosidl_typesupport_fastrtps_c.h"
...
using _UInt16__ros_msg_type = example_interfaces__msg__UInt16;
  ...
  void * untyped_ros_message)
{
  ...
  _UInt16__ros_msg_type * ros_message = static_cast<_UInt16__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    cdr >> ros_message->data;
  }
...
static uint32_t _UInt16__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__UInt16(
...
static size_t _UInt16__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_example_interfaces__msg__UInt16(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, UInt16)() {
