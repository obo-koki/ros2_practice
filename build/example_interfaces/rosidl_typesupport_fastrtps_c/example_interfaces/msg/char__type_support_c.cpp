...
#include "example_interfaces/msg/char__rosidl_typesupport_fastrtps_c.h"
...
using _Char__ros_msg_type = example_interfaces__msg__Char;
...
static uint32_t _Char__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__Char(
...
{
  return max_serialized_size_example_interfaces__msg__Char(
    full_bounded, 0);
}
