...
#include "example_interfaces/msg/int16_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _Int16MultiArray__ros_msg_type = example_interfaces__msg__Int16MultiArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Int16MultiArray__ros_msg_type * ros_message = static_cast<const _Int16MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Int16MultiArray__ros_msg_type * ros_message = static_cast<_Int16MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__int16__Sequence__fini(&ros_message->data);
    }
...
{
  return max_serialized_size_example_interfaces__msg__Int16MultiArray(
    full_bounded, 0);
}
