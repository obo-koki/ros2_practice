...
#include "example_interfaces/msg/empty__rosidl_typesupport_fastrtps_c.h"
...
using _Empty__ros_msg_type = example_interfaces__msg__Empty;
...
{
  return max_serialized_size_example_interfaces__msg__Empty(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, Empty)() {
