...
#include "example_interfaces/msg/u_int16_multi_array__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  _UInt16MultiArray__ros_msg_type * ros_message = static_cast<_UInt16MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__uint16__Sequence__fini(&ros_message->data);
    }
...
static size_t _UInt16MultiArray__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_example_interfaces__msg__UInt16MultiArray(
    full_bounded, 0);
}
