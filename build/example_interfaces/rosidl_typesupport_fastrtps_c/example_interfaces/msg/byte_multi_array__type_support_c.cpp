...
#include "example_interfaces/msg/byte_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _ByteMultiArray__ros_msg_type = example_interfaces__msg__ByteMultiArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ByteMultiArray__ros_msg_type * ros_message = static_cast<const _ByteMultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ByteMultiArray__ros_msg_type * ros_message = static_cast<_ByteMultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__octet__Sequence__fini(&ros_message->data);
    }
...
{
  return max_serialized_size_example_interfaces__msg__ByteMultiArray(
    full_bounded, 0);
}
