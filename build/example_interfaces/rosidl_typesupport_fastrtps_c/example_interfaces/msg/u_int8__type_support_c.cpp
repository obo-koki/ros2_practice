...
#include "example_interfaces/msg/u_int8__rosidl_typesupport_fastrtps_c.h"
...
using _UInt8__ros_msg_type = example_interfaces__msg__UInt8;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UInt8__ros_msg_type * ros_message = static_cast<const _UInt8__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UInt8__ros_msg_type * ros_message = static_cast<_UInt8__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    cdr >> ros_message->data;
  }
...
static uint32_t _UInt8__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__UInt8(
...
{
  return max_serialized_size_example_interfaces__msg__UInt8(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_UInt8 = {
...
static rosidl_message_type_support_t _UInt8__type_support = {
