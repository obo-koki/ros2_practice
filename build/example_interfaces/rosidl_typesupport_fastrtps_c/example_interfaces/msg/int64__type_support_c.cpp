...
#include "example_interfaces/msg/int64__rosidl_typesupport_fastrtps_c.h"
...
using _Int64__ros_msg_type = example_interfaces__msg__Int64;
  ...
  void * untyped_ros_message)
{
  ...
  _Int64__ros_msg_type * ros_message = static_cast<_Int64__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    cdr >> ros_message->data;
  }
...
static uint32_t _Int64__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__Int64(
...
static size_t _Int64__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_example_interfaces__msg__Int64(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, Int64)() {
