...
#include "example_interfaces/msg/w_string__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/u16string.h"  // data
#include "rosidl_generator_c/u16string_functions.h"  // data
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    if (!ros_message->data.data) {
      rosidl_generator_c__U16String__init(&ros_message->data);
    }
    std::wstring wstr;
    cdr >> wstr;
    ...
    if (!succeeded) {
      ...
      rosidl_generator_c__U16String__fini(&ros_message->data);
      return false;
    }
  }
