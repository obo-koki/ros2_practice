...
#include "example_interfaces/msg/float32_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _Float32MultiArray__ros_msg_type = example_interfaces__msg__Float32MultiArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Float32MultiArray__ros_msg_type * ros_message = static_cast<const _Float32MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Float32MultiArray__ros_msg_type * ros_message = static_cast<_Float32MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__float__Sequence__fini(&ros_message->data);
    }
...
static uint32_t _Float32MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__Float32MultiArray(
...
{
  return max_serialized_size_example_interfaces__msg__Float32MultiArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, Float32MultiArray)() {
