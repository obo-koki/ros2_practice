...
#include "example_interfaces/msg/float64_multi_array__rosidl_typesupport_fastrtps_c.h"
...
#include "example_interfaces/msg/multi_array_layout__functions.h"  // layout
...
using _Float64MultiArray__ros_msg_type = example_interfaces__msg__Float64MultiArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Float64MultiArray__ros_msg_type * ros_message = static_cast<const _Float64MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Float64MultiArray__ros_msg_type * ros_message = static_cast<_Float64MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Float64MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__Float64MultiArray(
...
{
  return max_serialized_size_example_interfaces__msg__Float64MultiArray(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Float64MultiArray = {
...
static rosidl_message_type_support_t _Float64MultiArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Float64MultiArray,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, Float64MultiArray)() {
  return &_Float64MultiArray__type_support;
}
