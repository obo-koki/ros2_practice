...
#include "example_interfaces/msg/u_int64_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _UInt64MultiArray__ros_msg_type = example_interfaces__msg__UInt64MultiArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UInt64MultiArray__ros_msg_type * ros_message = static_cast<const _UInt64MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UInt64MultiArray__ros_msg_type * ros_message = static_cast<_UInt64MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__uint64__Sequence__fini(&ros_message->data);
    }
...
static uint32_t _UInt64MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__UInt64MultiArray(
...
static size_t _UInt64MultiArray__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_example_interfaces__msg__UInt64MultiArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, UInt64MultiArray)() {
