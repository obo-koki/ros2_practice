...
#include "example_interfaces/msg/int32_multi_array__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  _Int32MultiArray__ros_msg_type * ros_message = static_cast<_Int32MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__int32__Sequence__fini(&ros_message->data);
    }
...
static uint32_t _Int32MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__Int32MultiArray(
...
{
  return max_serialized_size_example_interfaces__msg__Int32MultiArray(
    full_bounded, 0);
}
