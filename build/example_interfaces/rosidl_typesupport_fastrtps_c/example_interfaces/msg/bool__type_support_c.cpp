...
#include "example_interfaces/msg/bool__rosidl_typesupport_fastrtps_c.h"
...
using _Bool__ros_msg_type = example_interfaces__msg__Bool;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Bool__ros_msg_type * ros_message = static_cast<const _Bool__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Bool__ros_msg_type * ros_message = static_cast<_Bool__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    uint8_t tmp;
    cdr >> tmp;
...
static size_t _Bool__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_example_interfaces__msg__Bool(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, Bool)() {
