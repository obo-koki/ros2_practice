...
#include "example_interfaces/msg/byte__rosidl_typesupport_fastrtps_c.h"
...
using _Byte__ros_msg_type = example_interfaces__msg__Byte;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Byte__ros_msg_type * ros_message = static_cast<const _Byte__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Byte__ros_msg_type * ros_message = static_cast<_Byte__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    cdr >> ros_message->data;
  }
...
static uint32_t _Byte__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__Byte(
...
static size_t _Byte__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_example_interfaces__msg__Byte(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, Byte)() {
