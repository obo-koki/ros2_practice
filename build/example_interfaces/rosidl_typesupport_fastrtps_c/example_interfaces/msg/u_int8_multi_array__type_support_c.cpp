...
#include "example_interfaces/msg/u_int8_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _UInt8MultiArray__ros_msg_type = example_interfaces__msg__UInt8MultiArray;
  ...
  void * untyped_ros_message)
{
  ...
  _UInt8MultiArray__ros_msg_type * ros_message = static_cast<_UInt8MultiArray__ros_msg_type *>(untyped_ros_message);
  // Field name: layout
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _UInt8MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__msg__UInt8MultiArray(
...
{
  return max_serialized_size_example_interfaces__msg__UInt8MultiArray(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_UInt8MultiArray = {
...
static rosidl_message_type_support_t _UInt8MultiArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UInt8MultiArray,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, msg, UInt8MultiArray)() {
  return &_UInt8MultiArray__type_support;
}
