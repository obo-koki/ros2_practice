...
#include "example_interfaces/srv/trigger__rosidl_typesupport_fastrtps_c.h"
...
using _Trigger_Request__ros_msg_type = example_interfaces__srv__Trigger_Request;
...
static uint32_t _Trigger_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__srv__Trigger_Request(
...
{
  return max_serialized_size_example_interfaces__srv__Trigger_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, Trigger_Request)() {
...
using _Trigger_Response__ros_msg_type = example_interfaces__srv__Trigger_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__srv__Trigger_Response(
      untyped_ros_message, 0));
}
...
{
  return max_serialized_size_example_interfaces__srv__Trigger_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, Trigger_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, Trigger)() {
