...
example_interfaces__msg__UInt32MultiArray__init(example_interfaces__msg__UInt32MultiArray * msg)
{
  ...
  // data
  if (!rosidl_generator_c__uint32__Sequence__init(&msg->data, 0)) {
    example_interfaces__msg__UInt32MultiArray__fini(msg);
    return false;
  }
  return true;
...
example_interfaces__msg__UInt32MultiArray__fini(example_interfaces__msg__UInt32MultiArray * msg)
{
  ...
  // data
  rosidl_generator_c__uint32__Sequence__fini(&msg->data);
}

example_interfaces__msg__UInt32MultiArray *
example_interfaces__msg__UInt32MultiArray__create()
{
  example_interfaces__msg__UInt32MultiArray * msg = (example_interfaces__msg__UInt32MultiArray *)malloc(sizeof(example_interfaces__msg__UInt32MultiArray));
  if (!msg) {
    return NULL;
  }
...
example_interfaces__msg__UInt32MultiArray__Sequence__init(example_interfaces__msg__UInt32MultiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (example_interfaces__msg__UInt32MultiArray *)calloc(size, sizeof(example_interfaces__msg__UInt32MultiArray));
    if (!data) {
      return false;
    }
...
{
  example_interfaces__msg__UInt32MultiArray__Sequence * array = (example_interfaces__msg__UInt32MultiArray__Sequence *)malloc(sizeof(example_interfaces__msg__UInt32MultiArray__Sequence));
  if (!array) {
    return NULL;
  }
