...
#ifndef EXAMPLE_INTERFACES__MSG__BYTE_MULTI_ARRAY__STRUCT_H_
#define EXAMPLE_INTERFACES__MSG__BYTE_MULTI_ARRAY__STRUCT_H_
...
typedef struct example_interfaces__msg__ByteMultiArray
{
  ...
  rosidl_generator_c__octet__Sequence data;
...
#endif  // EXAMPLE_INTERFACES__MSG__BYTE_MULTI_ARRAY__STRUCT_H_
