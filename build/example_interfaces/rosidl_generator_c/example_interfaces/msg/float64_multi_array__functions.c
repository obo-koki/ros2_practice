...
example_interfaces__msg__Float64MultiArray__init(example_interfaces__msg__Float64MultiArray * msg)
{
  ...
  if (!example_interfaces__msg__MultiArrayLayout__init(&msg->layout)) {
    example_interfaces__msg__Float64MultiArray__fini(msg);
    return false;
  }
  // data
...
{
  example_interfaces__msg__Float64MultiArray * msg = (example_interfaces__msg__Float64MultiArray *)malloc(sizeof(example_interfaces__msg__Float64MultiArray));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(example_interfaces__msg__Float64MultiArray));
  bool success = example_interfaces__msg__Float64MultiArray__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
example_interfaces__msg__Float64MultiArray__Sequence__init(example_interfaces__msg__Float64MultiArray__Sequence * array, size_t size)
{
  ...
  example_interfaces__msg__Float64MultiArray * data = NULL;
  if (size) {
    data = (example_interfaces__msg__Float64MultiArray *)calloc(size, sizeof(example_interfaces__msg__Float64MultiArray));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = example_interfaces__msg__Float64MultiArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        example_interfaces__msg__Float64MultiArray__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
example_interfaces__msg__Float64MultiArray__Sequence__fini(example_interfaces__msg__Float64MultiArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      example_interfaces__msg__Float64MultiArray__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  example_interfaces__msg__Float64MultiArray__Sequence * array = (example_interfaces__msg__Float64MultiArray__Sequence *)malloc(sizeof(example_interfaces__msg__Float64MultiArray__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = example_interfaces__msg__Float64MultiArray__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    example_interfaces__msg__Float64MultiArray__Sequence__fini(array);
  }
  free(array);
}
