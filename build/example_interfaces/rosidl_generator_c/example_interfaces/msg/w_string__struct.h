...
#ifndef EXAMPLE_INTERFACES__MSG__W_STRING__STRUCT_H_
#define EXAMPLE_INTERFACES__MSG__W_STRING__STRUCT_H_
...
{
  rosidl_generator_c__U16String data;
...
#endif  // EXAMPLE_INTERFACES__MSG__W_STRING__STRUCT_H_
