...
{
  example_interfaces__msg__UInt8MultiArray * msg = (example_interfaces__msg__UInt8MultiArray *)malloc(sizeof(example_interfaces__msg__UInt8MultiArray));
  if (!msg) {
    return NULL;
  }
...
example_interfaces__msg__UInt8MultiArray__Sequence__init(example_interfaces__msg__UInt8MultiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (example_interfaces__msg__UInt8MultiArray *)calloc(size, sizeof(example_interfaces__msg__UInt8MultiArray));
    if (!data) {
      return false;
    }
...
{
  example_interfaces__msg__UInt8MultiArray__Sequence * array = (example_interfaces__msg__UInt8MultiArray__Sequence *)malloc(sizeof(example_interfaces__msg__UInt8MultiArray__Sequence));
  if (!array) {
    return NULL;
  }
