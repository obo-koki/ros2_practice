...
{
  example_interfaces__srv__Trigger_Request * msg = (example_interfaces__srv__Trigger_Request *)malloc(sizeof(example_interfaces__srv__Trigger_Request));
  if (!msg) {
    return NULL;
  }
...
example_interfaces__srv__Trigger_Request__Sequence__init(example_interfaces__srv__Trigger_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (example_interfaces__srv__Trigger_Request *)calloc(size, sizeof(example_interfaces__srv__Trigger_Request));
    if (!data) {
      return false;
    }
...
{
  example_interfaces__srv__Trigger_Request__Sequence * array = (example_interfaces__srv__Trigger_Request__Sequence *)malloc(sizeof(example_interfaces__srv__Trigger_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  example_interfaces__srv__Trigger_Response * msg = (example_interfaces__srv__Trigger_Response *)malloc(sizeof(example_interfaces__srv__Trigger_Response));
  if (!msg) {
    return NULL;
  }
...
example_interfaces__srv__Trigger_Response__Sequence__init(example_interfaces__srv__Trigger_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (example_interfaces__srv__Trigger_Response *)calloc(size, sizeof(example_interfaces__srv__Trigger_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  example_interfaces__srv__Trigger_Response__Sequence * array = (example_interfaces__srv__Trigger_Response__Sequence *)malloc(sizeof(example_interfaces__srv__Trigger_Response__Sequence));
  if (!array) {
    return NULL;
  }
