...
#ifndef EXAMPLE_INTERFACES__MSG__U_INT32_MULTI_ARRAY__STRUCT_HPP_
#define EXAMPLE_INTERFACES__MSG__U_INT32_MULTI_ARRAY__STRUCT_HPP_
...
struct UInt32MultiArray_
{
  ...
  explicit UInt32MultiArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : layout(_init)
  {
    (void)_init;
  }

  explicit UInt32MultiArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : layout(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // EXAMPLE_INTERFACES__MSG__U_INT32_MULTI_ARRAY__STRUCT_HPP_
