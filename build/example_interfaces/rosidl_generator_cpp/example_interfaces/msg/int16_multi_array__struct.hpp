...
#ifndef EXAMPLE_INTERFACES__MSG__INT16_MULTI_ARRAY__STRUCT_HPP_
#define EXAMPLE_INTERFACES__MSG__INT16_MULTI_ARRAY__STRUCT_HPP_
...
struct Int16MultiArray_
{
  ...
  explicit Int16MultiArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : layout(_init)
  {
    (void)_init;
  }

  explicit Int16MultiArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : layout(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // EXAMPLE_INTERFACES__MSG__INT16_MULTI_ARRAY__STRUCT_HPP_
