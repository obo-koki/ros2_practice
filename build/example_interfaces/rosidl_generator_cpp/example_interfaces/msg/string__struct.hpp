...
#ifndef EXAMPLE_INTERFACES__MSG__STRING__STRUCT_HPP_
#define EXAMPLE_INTERFACES__MSG__STRING__STRUCT_HPP_
...
struct String_
{
  ...
  explicit String_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit String_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // EXAMPLE_INTERFACES__MSG__STRING__STRUCT_HPP_
