...
#ifndef EXAMPLE_INTERFACES__MSG__FLOAT64__STRUCT_HPP_
#define EXAMPLE_INTERFACES__MSG__FLOAT64__STRUCT_HPP_
...
struct Float64_
{
  ...
  explicit Float64_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Float64_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // EXAMPLE_INTERFACES__MSG__FLOAT64__STRUCT_HPP_
