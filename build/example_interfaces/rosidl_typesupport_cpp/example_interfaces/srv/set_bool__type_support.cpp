...
static const _SetBool_Request_type_support_symbol_names_t _SetBool_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, srv, SetBool_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, srv, SetBool_Request)),
  }
};
...
get_message_type_support_handle<example_interfaces::srv::SetBool_Request>()
{
  return &::example_interfaces::srv::rosidl_typesupport_cpp::SetBool_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_interfaces, srv, SetBool_Request)() {
  return get_message_type_support_handle<example_interfaces::srv::SetBool_Request>();
}
...
static const _SetBool_Response_type_support_symbol_names_t _SetBool_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, srv, SetBool_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, srv, SetBool_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<example_interfaces::srv::SetBool_Response>()
{
  return &::example_interfaces::srv::rosidl_typesupport_cpp::SetBool_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_interfaces, srv, SetBool_Response)() {
  return get_message_type_support_handle<example_interfaces::srv::SetBool_Response>();
}
...
static const _SetBool_type_support_symbol_names_t _SetBool_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, srv, SetBool)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, srv, SetBool)),
  }
};
...
get_service_type_support_handle<example_interfaces::srv::SetBool>()
{
  return &::example_interfaces::srv::rosidl_typesupport_cpp::SetBool_service_type_support_handle;
}
