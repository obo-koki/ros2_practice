...
static const _UInt32MultiArray_type_support_symbol_names_t _UInt32MultiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, UInt32MultiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, UInt32MultiArray)),
  }
};
...
{
  return &::example_interfaces::msg::rosidl_typesupport_cpp::UInt32MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_interfaces, msg, UInt32MultiArray)() {
  return get_message_type_support_handle<example_interfaces::msg::UInt32MultiArray>();
}
