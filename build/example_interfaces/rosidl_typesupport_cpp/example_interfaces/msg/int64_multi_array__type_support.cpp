...
static const _Int64MultiArray_type_support_symbol_names_t _Int64MultiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, Int64MultiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, Int64MultiArray)),
  }
};
...
get_message_type_support_handle<example_interfaces::msg::Int64MultiArray>()
{
  return &::example_interfaces::msg::rosidl_typesupport_cpp::Int64MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_interfaces, msg, Int64MultiArray)() {
  return get_message_type_support_handle<example_interfaces::msg::Int64MultiArray>();
}
