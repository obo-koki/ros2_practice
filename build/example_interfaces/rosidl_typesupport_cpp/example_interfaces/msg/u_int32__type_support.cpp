...
#include "example_interfaces/msg/u_int32__struct.hpp"
...
static const _UInt32_type_support_symbol_names_t _UInt32_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, UInt32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, UInt32)),
  }
};
...
{
  return &::example_interfaces::msg::rosidl_typesupport_cpp::UInt32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_interfaces, msg, UInt32)() {
  return get_message_type_support_handle<example_interfaces::msg::UInt32>();
}
