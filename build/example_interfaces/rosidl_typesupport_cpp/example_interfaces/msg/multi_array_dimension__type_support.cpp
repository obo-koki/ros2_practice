...
#include "example_interfaces/msg/multi_array_dimension__struct.hpp"
...
static const _MultiArrayDimension_type_support_symbol_names_t _MultiArrayDimension_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, MultiArrayDimension)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, MultiArrayDimension)),
  }
};
...
{
  return &::example_interfaces::msg::rosidl_typesupport_cpp::MultiArrayDimension_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_interfaces, msg, MultiArrayDimension)() {
  return get_message_type_support_handle<example_interfaces::msg::MultiArrayDimension>();
}
