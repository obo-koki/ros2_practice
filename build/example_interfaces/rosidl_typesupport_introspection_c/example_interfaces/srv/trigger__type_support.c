...
#include <stddef.h>
#include "example_interfaces/srv/trigger__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_members = {
  "example_interfaces__srv",  // service namespace
  "Trigger",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_Request_message_type_support_handle,
  NULL  // response message
  // example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_Response_message_type_support_handle
};

static rosidl_service_type_support_t example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle = {
  0,
  &example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, example_interfaces, srv, Trigger)() {
  if (!example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle.typesupport_identifier) {
    example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle.data;
  ...
  return &example_interfaces__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle;
}
