...
#include <stddef.h>
#include "example_interfaces/msg/int32_multi_array__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Int32MultiArray__rosidl_typesupport_introspection_c__Int32MultiArray_message_member_array[2] = {
  {
    ...
    offsetof(example_interfaces__msg__Int32MultiArray, layout),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces__msg__Int32MultiArray, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Int32MultiArray__rosidl_typesupport_introspection_c__Int32MultiArray_message_members = {
  ...
  2,  // number of fields
  sizeof(example_interfaces__msg__Int32MultiArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, example_interfaces, msg, Int32MultiArray)() {
