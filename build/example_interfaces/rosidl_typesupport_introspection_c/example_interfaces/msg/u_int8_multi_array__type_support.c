...
#include <stddef.h>
#include "example_interfaces/msg/u_int8_multi_array__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember UInt8MultiArray__rosidl_typesupport_introspection_c__UInt8MultiArray_message_member_array[2] = {
  {
    ...
    offsetof(example_interfaces__msg__UInt8MultiArray, layout),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces__msg__UInt8MultiArray, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers UInt8MultiArray__rosidl_typesupport_introspection_c__UInt8MultiArray_message_members = {
  ...
  2,  // number of fields
  sizeof(example_interfaces__msg__UInt8MultiArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, example_interfaces, msg, UInt8MultiArray)() {
