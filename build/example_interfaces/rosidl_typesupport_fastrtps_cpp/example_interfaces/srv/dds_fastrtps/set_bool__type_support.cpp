...
#include "example_interfaces/srv/set_bool__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::srv::SetBool_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::srv::SetBool_Request & ros_message)
{
  // Member: data
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const example_interfaces::srv::SetBool_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::srv::SetBool_Request *>(
    untyped_ros_message);
...
static size_t _SetBool_Request__max_serialized_size(bool & full_bounded)
{
...
{
  return &example_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::srv::SetBool_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::srv::SetBool_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const example_interfaces::srv::SetBool_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::srv::SetBool_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _SetBool_Response__max_serialized_size(bool & full_bounded)
{
...
{
  return &example_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, srv, SetBool_Response)() {
  return &example_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
{
  return &example_interfaces::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, srv, SetBool)() {
  return &example_interfaces::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
