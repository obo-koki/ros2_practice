...
#include "example_interfaces/msg/u_int8_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt8MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::UInt8MultiArray *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt8MultiArray__handle;
}
