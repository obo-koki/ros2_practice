...
#include "example_interfaces/msg/float64_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::Float64MultiArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::Float64MultiArray & ros_message)
{
  // Member: layout
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Float64MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Float64MultiArray *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Float64MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, Float64MultiArray)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Float64MultiArray__handle;
}
