...
#include "example_interfaces/msg/u_int8__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::UInt8 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::UInt8 & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt8 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::UInt8 *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt8__handle;
}
