...
#include "example_interfaces/msg/float64__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::Float64 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::Float64 & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Float64 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Float64 *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Float64__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, Float64)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Float64__handle;
}
