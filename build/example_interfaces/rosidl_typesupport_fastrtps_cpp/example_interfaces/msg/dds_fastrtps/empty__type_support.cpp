...
#include "example_interfaces/msg/empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::Empty & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::Empty & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Empty *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Empty *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, Empty)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
