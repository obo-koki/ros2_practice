...
#include "example_interfaces/msg/int64_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Int64MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Int64MultiArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Int64MultiArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Int64MultiArray *>(
...
{
  return max_serialized_size_Int64MultiArray(full_bounded, 0);
}

static message_type_support_callbacks_t _Int64MultiArray__callbacks = {
...
static rosidl_message_type_support_t _Int64MultiArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Int64MultiArray__callbacks,
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Int64MultiArray__handle;
}
