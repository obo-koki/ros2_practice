...
#include "example_interfaces/msg/u_int64_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::UInt64MultiArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::UInt64MultiArray & ros_message)
{
  // Member: layout
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
max_serialized_size_UInt64MultiArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt64MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::UInt64MultiArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UInt64MultiArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt64MultiArray *>(
...
{
  return max_serialized_size_UInt64MultiArray(full_bounded, 0);
}

static message_type_support_callbacks_t _UInt64MultiArray__callbacks = {
...
static rosidl_message_type_support_t _UInt64MultiArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UInt64MultiArray__callbacks,
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt64MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, UInt64MultiArray)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt64MultiArray__handle;
}
