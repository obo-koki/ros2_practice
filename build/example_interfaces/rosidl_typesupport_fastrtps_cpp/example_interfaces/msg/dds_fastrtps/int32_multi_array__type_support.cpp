...
#include "example_interfaces/msg/int32_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
#include "example_interfaces/msg/int32_multi_array__struct.hpp"
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Int32MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Int32MultiArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Int32MultiArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Int32MultiArray *>(
...
static size_t _Int32MultiArray__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Int32MultiArray(full_bounded, 0);
}

static message_type_support_callbacks_t _Int32MultiArray__callbacks = {
...
static rosidl_message_type_support_t _Int32MultiArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Int32MultiArray__callbacks,
...
get_message_type_support_handle<example_interfaces::msg::Int32MultiArray>()
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Int32MultiArray__handle;
}
