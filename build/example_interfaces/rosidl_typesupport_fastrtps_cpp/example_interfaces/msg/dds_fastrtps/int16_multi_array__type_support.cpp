...
#include "example_interfaces/msg/int16_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::Int16MultiArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::Int16MultiArray & ros_message)
{
  // Member: layout
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Int16MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Int16MultiArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Int16MultiArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Int16MultiArray *>(
...
static size_t _Int16MultiArray__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Int16MultiArray(full_bounded, 0);
}

static message_type_support_callbacks_t _Int16MultiArray__callbacks = {
...
static rosidl_message_type_support_t _Int16MultiArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Int16MultiArray__callbacks,
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Int16MultiArray__handle;
}
