...
#include "example_interfaces/msg/u_int64__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt64 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::UInt64 *>(
    untyped_ros_message);
...
{
  return max_serialized_size_UInt64(full_bounded, 0);
}
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt64__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, UInt64)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt64__handle;
}
