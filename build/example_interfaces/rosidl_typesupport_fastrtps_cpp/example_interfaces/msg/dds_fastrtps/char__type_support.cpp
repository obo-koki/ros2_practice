...
#include "example_interfaces/msg/char__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::Char & ros_message,
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::Char *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::Char *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Char(full_bounded, 0);
}
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Char__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, Char)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_Char__handle;
}
