...
#include "example_interfaces/msg/u_int32_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::UInt32MultiArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::UInt32MultiArray & ros_message)
{
  // Member: layout
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt32MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::UInt32MultiArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UInt32MultiArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const example_interfaces::msg::UInt32MultiArray *>(
...
{
  return max_serialized_size_UInt32MultiArray(full_bounded, 0);
}

static message_type_support_callbacks_t _UInt32MultiArray__callbacks = {
...
static rosidl_message_type_support_t _UInt32MultiArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UInt32MultiArray__callbacks,
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_UInt32MultiArray__handle;
}
