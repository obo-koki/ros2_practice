...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetBool_Request_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces::srv::SetBool_Request, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetBool_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(example_interfaces::srv::SetBool_Request),
...
{
  return &::example_interfaces::srv::rosidl_typesupport_introspection_cpp::SetBool_Request_message_type_support_handle;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetBool_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::srv::SetBool_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::srv::SetBool_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetBool_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(example_interfaces::srv::SetBool_Response),
...
{
  return &::example_interfaces::srv::rosidl_typesupport_introspection_cpp::SetBool_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, srv, SetBool_Response)() {
  return &::example_interfaces::srv::rosidl_typesupport_introspection_cpp::SetBool_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetBool_service_members = {
  ...
  // see get_service_type_support_handle<example_interfaces::srv::SetBool>()
...
get_service_type_support_handle<example_interfaces::srv::SetBool>()
{
  ...
  auto service_type_support =
    &::example_interfaces::srv::rosidl_typesupport_introspection_cpp::SetBool_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, srv, SetBool)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<example_interfaces::srv::SetBool>();
}
