...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Bool_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces::msg::Bool, data),  // bytes offset in struct
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Bool_message_type_support_handle;
}
