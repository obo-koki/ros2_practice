...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float32_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces::msg::Float32, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float32_message_members = {
  ...
  1,  // number of fields
  sizeof(example_interfaces::msg::Float32),
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Float32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, Float32)() {
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Float32_message_type_support_handle;
}
