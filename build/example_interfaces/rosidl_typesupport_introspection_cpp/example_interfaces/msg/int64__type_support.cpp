...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int64_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces::msg::Int64, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int64_message_members = {
  ...
  "Int64",  // message name
  1,  // number of fields
  sizeof(example_interfaces::msg::Int64),
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Int64_message_type_support_handle;
}
