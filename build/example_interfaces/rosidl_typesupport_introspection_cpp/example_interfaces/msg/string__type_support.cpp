...
static const ::rosidl_typesupport_introspection_cpp::MessageMember String_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces::msg::String, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers String_message_members = {
  ...
  "String",  // message name
  1,  // number of fields
  sizeof(example_interfaces::msg::String),
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
