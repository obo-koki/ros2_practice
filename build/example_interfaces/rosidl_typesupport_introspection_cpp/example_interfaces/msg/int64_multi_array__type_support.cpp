...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int64MultiArray_message_member_array[2] = {
  {
    ...
    offsetof(example_interfaces::msg::Int64MultiArray, layout),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::msg::Int64MultiArray, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int64MultiArray_message_members = {
  ...
  2,  // number of fields
  sizeof(example_interfaces::msg::Int64MultiArray),
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Int64MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_interfaces, msg, Int64MultiArray)() {
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Int64MultiArray_message_type_support_handle;
}
