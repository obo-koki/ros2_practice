...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float32MultiArray_message_member_array[2] = {
  {
    ...
    offsetof(example_interfaces::msg::Float32MultiArray, layout),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::msg::Float32MultiArray, data),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::example_interfaces::msg::rosidl_typesupport_introspection_cpp::Float32MultiArray_message_type_support_handle;
}
